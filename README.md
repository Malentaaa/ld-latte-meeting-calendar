...
- создание встречи на одного и более участников;
...
- поиск общих свободных слотов по выбранным сотрудникам
...
### Поиск сводобных слотов

![Расписание](screenshots/search.png)
...
1. выбрано минимум одного участника (Это нужно для внешних встреч, например с поставщиком, подрядчиком, маркетплейсом или партнёром. Внешний участник указывается в теме или описании, а система контролирует занятость внутреннего сотрудника.);
